    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-96 bg-gradient-to-rfrom-[#F7C431] via-[#D1991C] to-[#B58215] overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[#F7C431]/90"></div>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-12 max-w-2xl mx-auto">
              <div className="space-y-6">
                <div className="w-24 h-24 mx-auto bg-gray-100 rounded-full flex items-center justify-center">
                  <svg className="w-12 h-12 text-[#F7C431]" fill="none" stroke="#F7C431" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-left">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-[#F7C431] rounded-full mr-3"></span>
                ...
                <div className="pt-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a
                      href="/contact"
                      className="bg-[#F7C431] text-white px-8 py-3 rounded-lg font-medium hover:bg-white hover:text-[#F7C431] hover:cursor-pointer hover:border-1 hover:border-[#F7C431] transition-colors"
                    >
                      Contact Us
                    </a>
                    <a
                      href="mailto:careers@Falloutburger.pk"
                      className="border border-[#F7C431] text-[#F7C431] px-8 py-3 rounded-lg font-medium hover:bg-[#F7C431] hover:text-white transition-colors"
                    >
                      Send Resume
                    </a>
                  </div>
