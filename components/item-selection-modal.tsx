          ...
          <div className=" flex-1 bg-white relative flex flex-col">
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="bg-[#F7C431] text-white px-3 mr-6 py-1 rounded text-sm font-medium">Required</span>
                  </div>
                    ...
                    {sizeOptions.map((size) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          {size.originalPrice && (
                            <div className="text-[#F7C431] line-through text-sm">{size.originalPrice.toFixed(2)}</div>
                          )}
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="bg-[#F7C431] text-white px-2 py-1 rounded text-xs">maximum 10</span>
                    </div>
                        ...
                        >
                          <div className="flex items-center space-x-3">
                            <input
                              ...
                              className="w-4 h-4 text-[#F7C431] border-gray-300 rounded focus:ring-[#F7C431]"
                            />
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="bg-[#F7C431] text-white px-2 py-1 rounded text-xs">maximum 9</span>
                    </div>
            ...
            <div className="border-t border-gray-200 p-6 bg-white">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-4">
                  <Button
                    ...
                    disabled={quantity <= 1}
                    className="w-14 h-14 p-0 bg-[#F7C431] text-white hover:cursor-pointer hover:bg-[#F7C431] hover:text-white border-[#F7C431]"
                  >
                  ...
                  <Button
                    ...
                    className="w-14 h-14 p-0 bg-[#F7C431] text-white hover:text-white hover:bg-[#F7C431] hover:cursor-pointer "
                  >
                ...
                <div className="text-right">
                  <div className="text-[#F7C431] line-through text-sm">{getOriginalPrice().toFixed(2)}</div>
              ...
              <Button
                ...
                className="w-full bg-[#F7C431] hover:border-1 hover:border-[#F7C431] hover:bg-white hover:text-[#F7C431] hover:cursor-pointer text-white py-6 text-xl  font-medium"
              >
                Add To Cart
              </Button>
            </div>
